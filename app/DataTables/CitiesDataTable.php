...
class CitiesDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.cities.actions', compact('item'), [
                    'editRoute' => route('admin.cities.edit', $item->id),
                    'deleteRoute' => route('admin.cities.destroy', $item->id),
                ]);
            })
            ...
            ->addColumn('country', function ($item) {
                return $item->country && $item->country->translate() ? $item->country->translate()->title : 'N/A';
            })
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('title')->title('Şəhər adı'),
            Column::make('country')->title('Ölkə'),
