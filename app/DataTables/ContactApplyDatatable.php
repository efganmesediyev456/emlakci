...
class ContactApplyDatatable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.contact_applies.actions', compact('item'), [
                    'deleteRoute' => route('admin.contactapplies.destroy', $item->id),
                ]);
            })
    ...
    public function query(ContactApply $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('phone')->title('Telefon nömrəsi'),
