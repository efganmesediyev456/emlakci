...
class FaqsDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.faqs.actions', compact('item'), [
                    'editRoute' => route('admin.faqs.edit', $item->id),
                    'deleteRoute' => route('admin.faqs.destroy', $item->id),
                ]);
            })
            ...
            ->addColumn('description', function ($item) {
                $description = $item->translate() ? $item->translate()->description : 'N/A';
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('description')->title('Qısa kontent'),
