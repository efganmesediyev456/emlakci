...
class HomeBannersDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.home_banners.actions', compact('item'), [
                    'editRoute' => route('admin.home_banners.edit', $item->id),
                    'deleteRoute' => route('admin.home_banners.destroy', $item->id),
                ]);
            })
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(HomeBanner::class)."'
                                },
    ...
    {
        return 'HomeBanners_' . date('YmdHis');
    }
}