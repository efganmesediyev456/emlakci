...
class RentFormDatatable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.rent-forms.actions', compact('item'), [
                    'deleteRoute' => route('admin.forms.rentFormDelete', $item->id),
                    'showRoute' => route('admin.forms.rentFormShow', $item->id),
                ]);
            })
    ...
    public function query(RentForm $model): QueryBuilder
    {
