...
class SaleFormDatatable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.sale-forms.actions', compact('item'), [
                    'deleteRoute' => route('admin.forms.saleFormDelete', $item->id),
                    'showRoute' => route('admin.forms.saleFormShow', $item->id),
                ]);
            })
    ...
    public function query(SaleForm $model): QueryBuilder
    {
