...
class TypeEstatesDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.type-estates.actions', compact('item'), [
                    'editRoute' => route('admin.type-estates.edit', $item->id),
                    'deleteRoute' => route('admin.type-estates.destroy', $item->id),
                ]);
            })
    ...
    public function query(TypeEstate $model): QueryBuilder
    {
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(TypeEstate::class)."'
                                },
    ...
    {
        return 'TypeEstates_' . date('YmdHis');
    }
}