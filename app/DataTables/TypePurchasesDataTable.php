...
class TypePurchasesDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.type-purchases.actions', compact('item'), [
                    'editRoute' => route('admin.type-purchases.edit', $item->id),
                    'deleteRoute' => route('admin.type-purchases.destroy', $item->id),
                ]);
            })
    ...
    public function query(TypePurchase $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('type-purchases-table')
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(TypePurchase::class)."'
                                },
    ...
    {
        return 'TypePurchases_' . date('YmdHis');
    }
}