...
class WeOnTheMediaDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.we_on_the_media.actions', compact('item'), [
                    'editRoute' => route('admin.we_on_the_media.edit', $item->id),
                    'deleteRoute' => route('admin.we_on_the_media.destroy', $item->id),
                ]);
            })
            ...
            ->editColumn('date', function ($item) {
                return $item->date ? date('d.m.Y', strtotime($item->date)) : 'N/A';
            })
    ...
    public function query(WeOnTheMedia $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('we-on-the-media-table')
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(WeOnTheMedia::class)."'
                                },
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('youtube_link')->title('YouTube Link'),
    ...
    {
        return 'WeOnTheMedia_' . date('YmdHis');
    }
}