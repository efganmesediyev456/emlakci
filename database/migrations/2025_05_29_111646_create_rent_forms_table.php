...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('rent_form_files', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger("rent_form_id")->nullable();
            $table->foreign("rent_form_id")->references("id")->on("rent_forms")->nullOnDelete();
