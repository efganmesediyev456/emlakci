    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Üstünlük</h4>
                <div class="buttons">
                    <a href="{{ route('admin.advantages.index') }}" class="btn btn-success">
        ...
        <div class="card-body">
            <form action="{{route('admin.advantages.update', $item->id)}}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        ...
                                        placeholder="Alt Başlıq daxil edin" value="{{ $item->translate($language->code)?->subtitle }}">
                                </div>
                            </div>
                        </div>
                    </div>
