    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>İnşa Nümunəsi Düzəliş - {{ $subcategories->translate() ? $subcategories->translate()->title : 'N/A' }}</h4>
                <div class="buttons">
                    <a href="{{ route('admin.subcategories.essay-examples.index', $subcategories->id) }}" class="btn btn-success gap-2 d-flex align-items-center">
        ...
        <div class="card-body">
            <form action="{{ route('admin.subcategories.essay-examples.update', [$subcategories->id, $item->id]) }}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
