                ...
                <div class="row gy-2 gx-4">
                    ...
                    <div class="col-md-6 video" style="{{ $item->type == 2 ? 'display: none;' : '' }}">
                        <div class="">
                            ...
                            @if($item->video_url)
                                <div class="mb-2">
                                    <a href="{{ asset('storage/' . $item->video_url) }}" target="_blank" class="btn btn-sm btn-info">
                                        <i class="fas fa-play"></i> Videoya bax
                                    </a>
                                </div>
                            @endif
                            <input type="file" class="form-control" name="video_url" id="video_url" placeholder="Video daxil edin">
                            <small class="text-muted">Boş buraxsanız, mövcud video saxlanılacaq</small>
                        </div>
                    </div>
