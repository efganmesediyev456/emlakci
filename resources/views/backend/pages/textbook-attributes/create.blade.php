            ...
            <div class="mb-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Key</label>
                            <input type="text" name="en_key" class="form-control" value="{{ old('en_key') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Value</label>
                            <input type="text" name="en_value" class="form-control" value="{{ old('en_value') }}" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Key</label>
                            <input type="text" name="ru_key" class="form-control" value="{{ old('ru_key') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Value</label>
                            <input type="text" name="ru_value" class="form-control" value="{{ old('ru_value') }}" required>
                        </div>
                    </div>
                </div>
            </div>
