    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Emlak növü</h4>
                <div class="buttons">
                    <a href="{{ route('admin.type-estates.index') }}" class="btn btn-success">
        ...
        <div class="card-body">
            <form action="{{route('admin.type-estates.update', $item->id)}}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
