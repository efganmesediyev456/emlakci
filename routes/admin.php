...
use App\Http\Controllers\Backend\EstateController;
...
use App\Http\Controllers\Backend\TypePurchaseController;
...
Route::middleware("auth:admin")->group(function () {
    ...
    Route::group(['prefix' => 'contact', 'as' => '.ouronmap'], function () {
    ...
    Route::group(['prefix' => 'home_banners', 'as' => '.home_banners'], function () {
        Route::get('/', [HomeBannerController::class, 'index'])->name('.index');
        Route::get('/create', [HomeBannerController::class, 'create'])->name('.create');
        Route::post('/store', [HomeBannerController::class, 'store'])->name('.store');
        Route::get('/{item}/edit', [HomeBannerController::class, 'edit'])->name('.edit');
        Route::put('/{item}/update', [HomeBannerController::class, 'update'])->name('.update');
        Route::delete('/{item}', [HomeBannerController::class, 'delete'])->name('.destroy');
    });
    ...
    Route::group(['prefix' => 'advantages', 'as' => '.advantages'], function () {
        ...
        Route::get('/{item}/edit', [AdvantageController::class, 'edit'])->name('.edit');
        Route::put('/{item}/update', [AdvantageController::class, 'update'])->name('.update');
        Route::delete('/{item}', [AdvantageController::class, 'delete'])->name('.destroy');
    });
    ...
    Route::group(['prefix' => 'faqs', 'as' => '.faqs'], function () {
        ...
        Route::get('/{item}/edit', [FaqController::class, 'edit'])->name('.edit');
        Route::put('/{item}/update', [FaqController::class, 'update'])->name('.update');
        Route::delete('/{item}', [FaqController::class, 'delete'])->name('.destroy');
    });
    ...
    Route::group(['prefix' => 'type-purchases', 'as' => '.type-purchases'], function () {
        Route::get('/', [TypePurchaseController::class, 'index'])->name('.index');
        Route::get('/create', [TypePurchaseController::class, 'create'])->name('.create');
        Route::post('/store', [TypePurchaseController::class, 'store'])->name('.store');
        Route::get('/{item}/edit', [TypePurchaseController::class, 'edit'])->name('.edit');
        Route::put('/{item}/update', [TypePurchaseController::class, 'update'])->name('.update');
        Route::delete('/{item}', [TypePurchaseController::class, 'delete'])->name('.destroy');
    });

    Route::group(['prefix' => 'type-estates', 'as' => '.type-estates'], function () {
        Route::get('/', [TypeEstateController::class, 'index'])->name('.index');
        Route::get('/create', [TypeEstateController::class, 'create'])->name('.create');
        Route::post('/store', [TypeEstateController::class, 'store'])->name('.store');
        Route::get('/{item}/edit', [TypeEstateController::class, 'edit'])->name('.edit');
        Route::put('/{item}/update', [TypeEstateController::class, 'update'])->name('.update');
        Route::delete('/{item}', [TypeEstateController::class, 'delete'])->name('.destroy');
    });
    ...
    Route::group(['prefix' => 'estates', 'as' => '.estates'], function () {
        ...
        Route::get('/create', [EstateController::class, 'create'])->name('.create');
        Route::post('/store', [EstateController::class, 'store'])->name('.store');
        Route::get('/{item}/edit', [EstateController::class, 'edit'])->name('.edit');
